# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-07-13 23:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, max_length=2, null=True, verbose_name=b'Country')),
        ...
        migrations.AddField(
            model_name='author',
            name='labs',
            field=models.ManyToManyField(blank=True, null=True, related_name='labs_set', to='lum.Lab', verbose_name=b'labs'),
        ),
    ]
